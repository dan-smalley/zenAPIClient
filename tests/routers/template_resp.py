...
list_templates_match = [('Devices/Server/TEST/rrdTemplates/MySQLServer', ''),
                        ('Devices/Server/TEST/rrdTemplates/FileSystem_NFS_Client',
                         'Linux file system monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/ethernetCsmacd',
                         'Ethernet (and default) network interface monitoring for Linux via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/HardDisk',
                         'Linux hard disk (block device) monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/LogicalVolume',
                         'Linux LVM logical volume monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/VolumeGroup',
                         'Linux LVM volume group monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/OSProcess',
                         'Linux process monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/MegaRaid', ''),
                        ('Devices/Server/TEST/rrdTemplates/FileSystem',
                         'Linux file system monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/Device',
                         'Linux device monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/PhysicalVolume',
                         'Linux LVM physical volume monitoring via SSH.'),
                        ('Devices/Server/TEST/rrdTemplates/SnapshotVolume',
                         'Linux LVM snapshot volume monitoring via SSH.')]
